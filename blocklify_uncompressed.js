...
goog.string.compareVersions=function(a,b){for(var c=0,d=goog.string.trim(String(a)).split("."),e=goog.string.trim(String(b)).split("."),f=Math.max(d.length,e.length),g=0;0==c&&g<f;g++){var h=d[g]||"",k=e[g]||"",l=RegExp("(\\d*)(\\D*)","g"),p=RegExp("(\\d*)(\\D*)","g");do{var n=l.exec(h)||["","",""],q=p.exec(k)||["","",""];if(0==n[0].length&&0==q[0].length)break;var c=0==n[1].length?0:parseInt(n[1],10),m=0==q[1].length?0:parseInt(q[1],10),c=goog.string.compareElements_(c,m)||goog.string.compareElements_(0==
...
(goog.asserts.assertElement(c),goog.dom.isFocusableTabIndex(c)&&goog.dom.setFocusableTabIndex(c,!1))},this);a.setStateInternal(d);g||(l.push(e),f==e&&(h=!0));h||l.push(f);var p=a.getExtraClassNames();p&&l.push.apply(l,p);if(goog.userAgent.IE&&!goog.userAgent.isVersionOrHigher("7")){var n=this.getAppliedCombinedClassNames_(l);0<n.length&&(l.push.apply(l,n),k=!0)}g&&h&&!p&&!k||goog.dom.classlist.set(b,l.join(" "));return b};
...
Blockly.Bubble.prototype.bubbleMouseDown_=function(a){this.promote_();Blockly.Bubble.unbindDragEvents_();if(!Blockly.isRightButton(a)&&!Blockly.isTargetInput_(a)){Blockly.Css.setCursor(Blockly.Css.Cursor.CLOSED);var b=Blockly.mouseToSvg(a);b.x/=Blockly.mainWorkspace.scale;b.y/=Blockly.mainWorkspace.scale;this.dragDeltaX=Blockly.RTL?this.relativeLeft_+b.x:this.relativeLeft_-b.x;this.dragDeltaY=this.relativeTop_-b.y;Blockly.Bubble.onMouseUpWrapper_=Blockly.bindEvent_(document,"mouseup",this,Blockly.Bubble.unbindDragEvents_);
Blockly.Bubble.onMouseMoveWrapper_=Blockly.bindEvent_(document,"mousemove",this,this.bubbleMouseMove_);Blockly.hideChaff();a.stopPropagation()}};Blockly.Bubble.prototype.bubbleMouseMove_=function(a){this.autoLayout_=!1;a=Blockly.mouseToSvg(a);a.x/=Blockly.mainWorkspace.scale;a.y/=Blockly.mainWorkspace.scale;this.relativeLeft_=Blockly.RTL?this.dragDeltaX-a.x:this.dragDeltaX+a.x;this.relativeTop_=this.dragDeltaY+a.y;this.positionBubble_();this.renderArrow_()};
...
Blockly.Bubble.prototype.layoutBubble_=function(){var a=-this.width_/4,b=-this.height_-Blockly.BlockSvg.MIN_BLOCK_Y,c=this.workspace_.getMetrics();c.viewWidth/=Blockly.mainWorkspace.scale;c.viewLeft/=Blockly.mainWorkspace.scale;Blockly.RTL?this.anchorX_-c.viewLeft-a-this.width_<Blockly.Scrollbar.scrollbarThickness?a=this.anchorX_-c.viewLeft-this.width_-Blockly.Scrollbar.scrollbarThickness:this.anchorX_-c.viewLeft-a>c.viewWidth&&(a=this.anchorX_-c.viewLeft-c.viewWidth):this.anchorX_+a<c.viewLeft?a=
c.viewLeft-this.anchorX_:c.viewLeft+c.viewWidth<this.anchorX_+a+this.width_+Blockly.BlockSvg.SEP_SPACE_X+Blockly.Scrollbar.scrollbarThickness&&(a=c.viewLeft+c.viewWidth-this.anchorX_-this.width_-Blockly.Scrollbar.scrollbarThickness);this.anchorY_+b<c.viewTop&&(b=this.shape_.getBBox().height/Blockly.mainWorkspace.scale);this.relativeLeft_=a;this.relativeTop_=b};
...
Blockly.Connection.prototype.moveTo=function(a,b){this.inDB_&&this.dbList_[this.type].removeConnection_(this);this.x_=a;this.y_=b;this.hidden_||this.dbList_[this.type].addConnection_(this)};Blockly.Connection.prototype.moveBy=function(a,b){this.moveTo(this.x_+a,this.y_+b)};Blockly.Connection.prototype.setHidden=function(a){(this.hidden_=a)&&this.inDB_?this.dbList_[this.type].removeConnection_(this):a||this.inDB_||this.dbList_[this.type].addConnection_(this)};
...
Blockly.WorkspaceSvg=function(a,b){Blockly.WorkspaceSvg.superClass_.constructor.call(this);this.getMetrics=a;this.setMetrics=b;Blockly.ConnectionDB.init(this)};goog.inherits(Blockly.WorkspaceSvg,Blockly.Workspace);Blockly.WorkspaceSvg.prototype.rendered=!0;Blockly.WorkspaceSvg.prototype.isFlyout=!1;Blockly.WorkspaceSvg.prototype.dragMode=!1;Blockly.WorkspaceSvg.prototype.scrollX=0;Blockly.WorkspaceSvg.prototype.scrollY=0;Blockly.Workspace.prototype.zooming=!0;Blockly.Workspace.prototype.scale=1;
Blockly.Workspace.prototype.scaleSpeed=1.2;Blockly.Workspace.prototype.minScale=.3;Blockly.Workspace.prototype.maxScale=3;Blockly.Workspace.prototype.mousePosition=null;Blockly.WorkspaceSvg.prototype.trashcan=null;Blockly.WorkspaceSvg.prototype.scrollbar=null;
Blockly.WorkspaceSvg.prototype.createDom=function(){this.svgGroup_=Blockly.createSvgElement("g",{},null);this.svgBlockCanvas_=Blockly.createSvgElement("g",{},this.svgGroup_);this.svgBubbleCanvas_=Blockly.createSvgElement("g",{},this.svgGroup_);this.fireChangeEvent();return this.svgGroup_};
...
Blockly.WorkspaceSvg.prototype.isDeleteArea=function(a){a=Blockly.mouseToSvg(a);a=new goog.math.Coordinate(a.x,a.y);if(this.deleteAreaToolbox_&&this.deleteAreaToolbox_.contains(a))return Blockly.Css.setCursor(Blockly.Css.Cursor.DELETE),!0;if(this.deleteAreaTrash_){if(this.deleteAreaTrash_.contains(a))return this.trashcan.setOpen_(!0),Blockly.Css.setCursor(Blockly.Css.Cursor.DELETE),!0;this.trashcan.setOpen_(!1)}Blockly.Css.setCursor(Blockly.Css.Cursor.CLOSED);return!1};
...
Blockly.BlockSvg.prototype.initSvg=function(){goog.asserts.assert(this.workspace.rendered,"Workspace is headless.");for(var a=0,b;b=this.inputList[a];a++)b.init();this.mutator&&this.mutator.createIcon();this.updateColour();Blockly.readOnly||this.eventsInit_||(Blockly.bindEvent_(this.getSvgRoot(),"mousedown",this,this.onMouseDown_),Blockly.bindEvent_(this.getSvgRoot(),"contextmenu",this,this.onContextMenu_));goog.isFunction(this.onchange)&&!this.eventsInit_&&Blockly.bindEvent_(this.workspace.getCanvas(),
"blocklyWorkspaceChange",this,this.onchange);this.eventsInit_=!0;this.getSvgRoot().parentNode||this.workspace.getCanvas().appendChild(this.getSvgRoot())};Blockly.BlockSvg.prototype.select=function(){Blockly.selected&&Blockly.selected.unselect();Blockly.selected=this;this.addSelect();Blockly.fireUiEvent(this.workspace.getCanvas(),"blocklySelectChange")};Blockly.BlockSvg.prototype.unselect=function(){Blockly.selected=null;this.removeSelect();Blockly.fireUiEvent(this.workspace.getCanvas(),"blocklySelectChange")};
Blockly.BlockSvg.prototype.mutator=null;Blockly.BlockSvg.prototype.comment=null;Blockly.BlockSvg.prototype.warning=null;Blockly.BlockSvg.prototype.getIcons=function(){var a=[];this.mutator&&a.push(this.mutator);this.comment&&a.push(this.comment);this.warning&&a.push(this.warning);return a};Blockly.BlockSvg.onMouseUpWrapper_=null;Blockly.BlockSvg.onMouseMoveWrapper_=null;
...
Blockly.BlockSvg.prototype.setCollapsed=function(a){if(this.collapsed_!=a){Blockly.BlockSvg.superClass_.setCollapsed.call(this,a);for(var b=[],c=0,d;d=this.inputList[c];c++)b.push.apply(b,d.setVisible(!a));if(a){a=this.getIcons();for(c=0;c<a.length;c++)a[c].setVisible(!1);c=this.toString(Blockly.COLLAPSE_CHARS);this.appendDummyInput("_TEMP_COLLAPSED_INPUT").appendField(c).init()}else this.removeInput("_TEMP_COLLAPSED_INPUT");b.length||(b[0]=this);if(this.rendered){for(c=0;a=b[c];c++)a.render();this.bumpNeighbours_()}}};
...
c&&goog.Timer.callOnce(c.close,100,c);Blockly.selected.dispose(!1,!0);Blockly.fireUiEvent(window,"resize")}Blockly.highlightedConnection_&&(Blockly.highlightedConnection_.unhighlight(),Blockly.highlightedConnection_=null);Blockly.Css.setCursor(Blockly.Css.Cursor.OPEN)})};Blockly.BlockSvg.prototype.onContextMenu_=function(a){this.showContextMenu_(a);a.stopPropagation();a.preventDefault()};
...
Blockly.BlockSvg.prototype.onMouseMove_=function(a){var b=this;Blockly.doCommand(function(){if(!("mousemove"==a.type&&1>=a.clientX&&0==a.clientY&&0==a.button)){Blockly.removeAllRanges();var c=a.clientX-b.startDragMouseX,d=a.clientY-b.startDragMouseY,c=c/Blockly.mainWorkspace.scale,d=d/Blockly.mainWorkspace.scale;1==Blockly.dragMode_&&Math.sqrt(Math.pow(c,2)+Math.pow(d,2))>Blockly.DRAG_RADIUS&&(Blockly.dragMode_=2,b.setParent(null),b.setDragging_(!0),b.workspace.recordDeleteAreas());if(2==Blockly.dragMode_){var e=
b.startDragX+c,f=b.startDragY+d;b.getSvgRoot().setAttribute("transform","translate("+e+", "+f+")");for(e=0;e<b.draggedBubbles_.length;e++)f=b.draggedBubbles_[e],f.bubble.setIconLocation(f.x+c,f.y+d);for(var f=b.getConnections_(!1),g=null,h=null,k=Blockly.SNAP_RADIUS,e=0;e<f.length;e++){var l=f[e],p=l.closest(k,c,d);p.connection&&(g=p.connection,h=l,k=p.radius)}Blockly.highlightedConnection_&&Blockly.highlightedConnection_!=g&&(Blockly.highlightedConnection_.unhighlight(),Blockly.highlightedConnection_=
...
Blockly.BlockSvg.disposeUiStep_=function(a){var b=(new Date-a.startDate_)/150;1<b?goog.dom.removeNode(a):(a.setAttribute("transform","translate("+(a.translateX_+(Blockly.RTL?-1:1)*a.bBox_.width/2*b+", "+(a.translateY_+a.bBox_.height*b))+") scale("+(1-b)*Blockly.mainWorkspace.scale+")"),setTimeout(function(){Blockly.BlockSvg.disposeUiStep_(a)},10))};
Blockly.BlockSvg.prototype.connectionUiEffect=function(){Blockly.playAudio("click");var a=Blockly.getSvgXY_(this.svgGroup_);this.outputConnection?(a.x+=(Blockly.RTL?3:-3)*Blockly.mainWorkspace.scale,a.y+=13*Blockly.mainWorkspace.scale):this.previousConnection&&(a.x+=(Blockly.RTL?-23:23)*Blockly.mainWorkspace.scale,a.y+=3*Blockly.mainWorkspace.scale);a=Blockly.createSvgElement("circle",{cx:a.x,cy:a.y,r:0,fill:"none",stroke:"#888","stroke-width":10},Blockly.svg);a.startDate_=new Date;Blockly.BlockSvg.connectionUiStep_(a)};
Blockly.BlockSvg.connectionUiStep_=function(a){var b=(new Date-a.startDate_)/150;1<b?goog.dom.removeNode(a):(a.setAttribute("r",25*b*Blockly.mainWorkspace.scale),a.style.opacity=1-b,setTimeout(function(){Blockly.BlockSvg.connectionUiStep_(a)},10))};
...
Blockly.BlockSvg.prototype.renderCompute_=function(a){var b=this.inputList,c=[];c.rightEdge=a+2*Blockly.BlockSvg.SEP_SPACE_X;if(this.previousConnection||this.nextConnection)c.rightEdge=Math.max(c.rightEdge,Blockly.BlockSvg.NOTCH_WIDTH+Blockly.BlockSvg.SEP_SPACE_X);for(var d=0,e=0,f=!1,g=!1,h=!1,k=void 0,l=this.inputsInline&&!this.isCollapsed(),p=0,n;n=b[p];p++)if(n.isVisible()){var q;l&&k&&k!=Blockly.NEXT_STATEMENT&&n.type!=Blockly.NEXT_STATEMENT?q=c[c.length-1]:(k=n.type,q=[],q.type=l&&n.type!=Blockly.NEXT_STATEMENT?
Blockly.BlockSvg.INLINE:n.type,q.height=0,c.push(q));q.push(n);n.renderHeight=Blockly.BlockSvg.MIN_BLOCK_Y;n.renderWidth=l&&n.type==Blockly.INPUT_VALUE?Blockly.BlockSvg.TAB_WIDTH+1.25*Blockly.BlockSvg.SEP_SPACE_X:0;if(n.connection&&n.connection.targetConnection){var m=n.connection.targetBlock().getHeightWidth();n.renderHeight=Math.max(n.renderHeight,m.height);n.renderWidth=Math.max(n.renderWidth,m.width)}p==b.length-1&&n.renderHeight--;q.height=Math.max(q.height,n.renderHeight);n.fieldWidth=0;1==
c.length&&(n.fieldWidth+=Blockly.RTL?-a:a);for(var m=!1,r=0,t;t=n.fieldRow[r];r++){0!=r&&(n.fieldWidth+=Blockly.BlockSvg.SEP_SPACE_X);var u=t.getSize();t.renderWidth=u.width;t.renderSep=m&&t.EDITABLE?Blockly.BlockSvg.SEP_SPACE_X:0;n.fieldWidth+=t.renderWidth+t.renderSep;q.height=Math.max(q.height,u.height);m=t.EDITABLE}q.type!=Blockly.BlockSvg.INLINE&&(q.type==Blockly.NEXT_STATEMENT?(g=!0,e=Math.max(e,n.fieldWidth)):(q.type==Blockly.INPUT_VALUE?f=!0:q.type==Blockly.DUMMY_INPUT&&(h=!0),d=Math.max(d,
n.fieldWidth)))}for(a=0;q=c[a];a++)if(q.thicker=!1,q.type==Blockly.BlockSvg.INLINE)for(b=0;n=q[b];b++)if(n.type==Blockly.INPUT_VALUE){q.height+=2*Blockly.BlockSvg.INLINE_PADDING_Y;q.thicker=!0;break}c.statementEdge=2*Blockly.BlockSvg.SEP_SPACE_X+e;g&&(c.rightEdge=Math.max(c.rightEdge,c.statementEdge+Blockly.BlockSvg.NOTCH_WIDTH));f?c.rightEdge=Math.max(c.rightEdge,d+2*Blockly.BlockSvg.SEP_SPACE_X+Blockly.BlockSvg.TAB_WIDTH):h&&(c.rightEdge=Math.max(c.rightEdge,d+2*Blockly.BlockSvg.SEP_SPACE_X));c.hasValue=
...
Blockly.BlockSvg.TAB_WIDTH+1))):q.type==Blockly.DUMMY_INPUT?(m=q[0],l=k+Blockly.BlockSvg.FIELD_HEIGHT,m.align!=Blockly.ALIGN_LEFT&&(r=f.rightEdge-m.fieldWidth-2*Blockly.BlockSvg.SEP_SPACE_X,f.hasValue&&(r-=Blockly.BlockSvg.TAB_WIDTH),m.align==Blockly.ALIGN_RIGHT?h+=r:m.align==Blockly.ALIGN_CENTRE&&(h+=(r+h)/2)),this.renderFields_(m.fieldRow,h,l),a.push("v",q.height),Blockly.RTL&&b.push("v",q.height-2)):q.type==Blockly.NEXT_STATEMENT&&(m=q[0],0==n&&(a.push("v",Blockly.BlockSvg.SEP_SPACE_Y),Blockly.RTL&&
b.push("v",Blockly.BlockSvg.SEP_SPACE_Y-1),k+=Blockly.BlockSvg.SEP_SPACE_Y),l=k+Blockly.BlockSvg.FIELD_HEIGHT,m.align!=Blockly.ALIGN_LEFT&&(r=f.statementEdge-m.fieldWidth-2*Blockly.BlockSvg.SEP_SPACE_X,m.align==Blockly.ALIGN_RIGHT?h+=r:m.align==Blockly.ALIGN_CENTRE&&(h+=(r+h)/2)),this.renderFields_(m.fieldRow,h,l),h=f.statementEdge+Blockly.BlockSvg.NOTCH_WIDTH,a.push("H",h),a.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER),a.push("v",q.height-2*Blockly.BlockSvg.CORNER_RADIUS),a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER),
...
b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_LTR),b.push("H",f.rightEdge)),l=e.x+(Blockly.RTL?-h:h),p=e.y+k+1,m.connection.moveTo(l,p),m.connection.targetConnection&&(m.connection.tighten_(),this.width=Math.max(this.width,f.statementEdge+m.connection.targetBlock().getHeightWidth().width)),n==f.length-1||f[n+1].type==Blockly.NEXT_STATEMENT)&&(a.push("v",Blockly.BlockSvg.SEP_SPACE_Y),Blockly.RTL&&b.push("v",Blockly.BlockSvg.SEP_SPACE_Y-1),k+=Blockly.BlockSvg.SEP_SPACE_Y);k+=q.height}f.length||
...
// Copyright 2012 Google Inc.  Apache License 2.0
Blockly.FieldTextArea=function(a,b){Blockly.FieldTextArea.superClass_.constructor.call(this,a);this.changeHandler_=b};goog.inherits(Blockly.FieldTextArea,Blockly.Field);Blockly.FieldTextArea.prototype.clone=function(){return new Blockly.FieldTextArea(this.getText(),this.changeHandler_)};Blockly.FieldTextArea.prototype.CURSOR="text";Blockly.FieldTextArea.prototype.dispose=function(){Blockly.WidgetDiv.hideIfOwner(this);Blockly.FieldTextArea.superClass_.dispose.call(this)};
Blockly.FieldTextArea.prototype.setText=function(a){if(null!==a){if(this.changeHandler_){var b=this.changeHandler_(a);null!==b&&void 0!==b&&(a=b)}if(null!==a&&a!==this.text_){this.text_=a;this.textElement_&&goog.dom.removeChildren(this.textElement_);Blockly.RTL&&a&&(a+="\u200f");a||(a=Blockly.Field.NBSP);var c=2,d=this;a.split(/\n/).map(function(a){a=a.replace(/\s/g,Blockly.Field.NBSP);Blockly.createSvgElement("tspan",{x:0,y:c},d.textElement_).appendChild(document.createTextNode(a));c+=20});this.size_.width=
0;this.sourceBlock_&&this.sourceBlock_.rendered&&(this.sourceBlock_.render(),this.sourceBlock_.bumpNeighbours_(),this.sourceBlock_.workspace.fireChangeEvent())}}};
...
Blockly.FieldTextArea.prototype.onHtmlInputChange_=function(a){var b=Blockly.FieldTextArea.htmlInput_;27==a.keyCode?(this.setText(b.defaultValue),Blockly.WidgetDiv.hide()):(a=b.value,a!==b.oldValue_?(b.oldValue_=a,this.setText(a),this.validate_()):goog.userAgent.WEBKIT&&this.sourceBlock_.render(),this.resizeEditor_())};
Blockly.FieldTextArea.prototype.validate_=function(){var a=!0;goog.asserts.assertObject(Blockly.FieldTextArea.htmlInput_);var b=Blockly.FieldTextArea.htmlInput_;this.changeHandler_&&(a=this.changeHandler_(b.value));null===a?Blockly.addClass_(b,"blocklyInvalidInput"):Blockly.removeClass_(b,"blocklyInvalidInput")};
Blockly.FieldTextArea.prototype.resizeEditor_=function(){var a=Blockly.WidgetDiv.DIV,b=this.fieldGroup_.getBBox();a.style.width=b.width+"px";a.style.height=b.height+"px";b=Blockly.getAbsoluteXY_(this.borderRect_);if(Blockly.RTL){var c=this.borderRect_.getBBox();b.x+=c.width;b.x-=a.offsetWidth}b.y+=1;goog.userAgent.WEBKIT&&(b.y-=3);a.style.left=b.x+"px";a.style.top=b.y+"px"};
Blockly.FieldTextArea.prototype.widgetDispose_=function(){var a=this;return function(){var b=Blockly.FieldTextArea.htmlInput_,c=b.value;a.changeHandler_&&(c=a.changeHandler_(c),null===c&&(c=b.defaultValue));a.setText(c);a.sourceBlock_.rendered&&a.sourceBlock_.render();Blockly.unbindEvent_(b.onKeyUpWrapper_);Blockly.unbindEvent_(b.onKeyPressWrapper_);Blockly.unbindEvent_(b.onWorkspaceChangeWrapper_);Blockly.FieldTextArea.htmlInput_=null;Blockly.WidgetDiv.DIV.style.width="auto"}};
// Copyright 2012 Google Inc.  Apache License 2.0
...
Blockly.Flyout.prototype.wheel_=function(a){var b=a.deltaY||-a.wheelDeltaY;if(b){goog.userAgent.GECKO&&(b*=10);var c=this.getMetrics_(),b=c.viewTop+b,b=Math.min(b,c.contentHeight-c.viewHeight),b=Math.max(b,0);this.scrollbar_.set(b);a.preventDefault();a.stopPropagation()}};Blockly.Flyout.prototype.isVisible=function(){return this.svgGroup_&&"block"==this.svgGroup_.style.display};
...
Blockly.Flyout.prototype.createBlockFunc_=function(a){var b=this;return function(c){if(!Blockly.isRightButton(c)&&!a.disabled){var d=Blockly.Xml.blockToDom_(a),d=Blockly.Xml.domToBlock(b.targetWorkspace_,d),e=a.getSvgRoot();if(!e)throw"originBlock is not rendered.";var f=d.getSvgRoot();if(!f)throw"block is not rendered.";if(b.targetWorkspace_===Blockly.mainWorkspace){var e=Blockly.getSvgXY_(e),g=Blockly.mainWorkspace.mousePosition,h=g.x-e.x,g=g.y-e.y;e.x/=Blockly.mainWorkspace.scale;e.y/=Blockly.mainWorkspace.scale;
var k=Blockly.getRelativeXY_(Blockly.mainWorkspace.getCanvas()),f=Blockly.getRelativeXY_(f);d.moveBy(e.x-(k.x/Blockly.mainWorkspace.scale+f.x)-(h-h/Blockly.mainWorkspace.scale),e.y-(k.y/Blockly.mainWorkspace.scale+f.y)-(g-g/Blockly.mainWorkspace.scale))}else e=Blockly.getSvgXY_(e),f=Blockly.getSvgXY_(f),d.moveBy(e.x-f.x,e.y-f.y);b.autoClose?b.hide():b.filterForCapacity_();d.onMouseDown_(c)}}};
...
Blockly.Flyout.prototype.getRect=function(){var a=Blockly.getSvgXY_(this.svgGroup_).x;Blockly.RTL||(a-=1E7);return Blockly.isDescendant_(this.svgGroup_,Blockly.mainWorkspace.getBubbleCanvas())?new goog.math.Rect(a,-1E7,1E7+this.width_*Blockly.mainWorkspace.scale,this.height_*Blockly.mainWorkspace.scale+2E7):new goog.math.Rect(a,-1E7,1E7+this.width_,this.height_+2E7)};
// Copyright 2011 Google Inc.  Apache License 2.0
...
Blockly.parseOptions_=function(a){var b=!!a.readOnly;if(b)var c=!1,d=!1,e=!1,f=!1,g=!1,h=null;else h=Blockly.parseToolboxTree_(a.toolbox),c=Boolean(h&&h.getElementsByTagName("category").length),d=a.trashcan,void 0===d&&(d=c),e=a.collapse,void 0===e&&(e=c),f=a.comments,void 0===f&&(f=c),g=a.disable,void 0===g&&(g=c);var k=a.scrollbars;void 0===k&&(k=c);var l=a.sounds;void 0===l&&(l=!0);var p=a.css;void 0===p&&(p=!0);var n=!!a.realtime,q=n?a.realtimeOptions:void 0;Blockly.enableZoom=a.zoom;Blockly.zoomOptions=
a.zoomOptions;Blockly.RTL=!!a.rtl;Blockly.collapse=e;Blockly.comments=f;Blockly.disable=g;Blockly.readOnly=b;Blockly.maxBlocks=a.maxBlocks||Infinity;a.media?Blockly.pathToMedia=a.media:a.path&&(Blockly.pathToMedia=a.path+"media/");Blockly.hasCategories=c;Blockly.hasScrollbars=k;Blockly.hasTrashcan=d;Blockly.hasSounds=l;Blockly.hasCss=p;Blockly.languageTree=h;Blockly.enableRealtime=n;Blockly.realtimeOptions=q};
...
Blockly.init_=function(){Blockly.bindEvent_(Blockly.svg,"mousedown",null,Blockly.onMouseDown_);Blockly.bindEvent_(Blockly.svg,"DOMMouseScroll",null,Blockly.onMouseWheel_);Blockly.bindEvent_(Blockly.svg,"mousewheel",null,Blockly.onMouseWheel_);Blockly.bindEvent_(Blockly.svg,"mousemove",null,Blockly.onMouseMoveTracking_);Blockly.bindEvent_(Blockly.svg,"contextmenu",null,Blockly.onContextMenu_);Blockly.bindEvent_(Blockly.WidgetDiv.DIV,"contextmenu",null,Blockly.onContextMenu_);Blockly.documentEventsBound_||
...
void 0!=Blockly.enableZoom&&(Blockly.mainWorkspace.zooming=Blockly.enableZoom);Blockly.zoomOptions&&(Blockly.zoomOptions.maxScale&&(Blockly.mainWorkspace.maxScale=Blockly.zoomOptions.maxScale),Blockly.zoomOptions.minScale&&(Blockly.mainWorkspace.minScale=Blockly.zoomOptions.minScale),Blockly.zoomOptions.scaleSpeed&&(Blockly.mainWorkspace.scaleSpeed=Blockly.zoomOptions.scaleSpeed));Blockly.mainWorkspace.addTrashcan();if(Blockly.hasSounds){Blockly.loadAudio_([Blockly.pathToMedia+"click.mp3",Blockly.pathToMedia+
"click.wav",Blockly.pathToMedia+"click.ogg"],"click");Blockly.loadAudio_([Blockly.pathToMedia+"delete.mp3",Blockly.pathToMedia+"delete.ogg",Blockly.pathToMedia+"delete.wav"],"delete");var b=[],a=function(){for(;b.length;)Blockly.unbindEvent_(b.pop());Blockly.preloadAudio_()};b.push(Blockly.bindEvent_(document,"mousemove",null,a));b.push(Blockly.bindEvent_(document,"touchstart",null,a))}};
...
Blockly.bindEvent_=function(a,b,c,d){var e=function(a){d.call(c,a)};a.addEventListener(b,e,!1);var f=[[a,b,e]];if(b in Blockly.bindEvent_.TOUCH_MAP)for(var e=function(a){if(1==a.changedTouches.length){var b=a.changedTouches[0];a.clientX=b.clientX;a.clientY=b.clientY}d.call(c,a);"touchstart"!=a.type&&a.preventDefault()},g=0,h;h=Blockly.bindEvent_.TOUCH_MAP[b][g];g++)a.addEventListener(h,e,!1),f.push([a,h,e]);return f};Blockly.bindEvent_.TOUCH_MAP={};
...
Blockly.getRelativeXY_=function(a){var b={x:0,y:0},c=a.getAttribute("x");c&&(b.x=parseInt(c,10));if(c=a.getAttribute("y"))b.y=parseInt(c,10);if(a=(a=a.getAttribute("transform"))&&a.match(/translate\(\s*([-\d.]+)([ ,]\s*([-\d.]+)\s*\))?/))b.x+=parseInt(a[1],10),a[3]&&(b.y+=parseInt(a[3],10));return b};Blockly.isDescendant_=function(a,b){for(var c=a.parentNode;null!=c;){if(c==b)return!0;c=c.parentNode}return!1};
Blockly.getSvgXY_=function(a){var b=0,c=0,d;d=(d=!Blockly.isDescendant_(a,Blockly.mainWorkspace.getCanvas()))&&!Blockly.isDescendant_(a,Blockly.mainWorkspace.getBubbleCanvas());do{var e=Blockly.getRelativeXY_(a);if(a===Blockly.mainWorkspace.getCanvas()||a===Blockly.mainWorkspace.getBubbleCanvas())d=!0;d?(b+=e.x,c+=e.y):(b+=e.x*Blockly.mainWorkspace.scale,c+=e.y*Blockly.mainWorkspace.scale);a=a.parentNode}while(a&&a!=Blockly.svg);return{x:b,y:c}};
Blockly.getAbsoluteXY_=function(a){a=Blockly.getSvgXY_(a);return Blockly.convertCoordinates(a.x,a.y,!1)};
Blockly.createSvgElement=function(a,b,c){var d=document.createElementNS(Blockly.SVG_NS,a),e;for(e in b)d.setAttribute(e,b[e]);var f=d.getBBox;d.getBBox=function(){var a=f.call(d);if(Blockly.mainWorkspace){var b=d;do{Blockly.getRelativeXY_(b);if(b===Blockly.mainWorkspace.getCanvas()){a.width*=Blockly.mainWorkspace.scale;a.height*=Blockly.mainWorkspace.scale;break}b=b.parentNode}while(b&&b!=Blockly.svg)}else a=f.call(d),2==d.transform.baseVal.numberOfItems&&(a.width*=d.transform.baseVal.getItem(1).matrix.a,
a.height*=d.transform.baseVal.getItem(1).matrix.d);return a};document.body.runtimeStyle&&(d.runtimeStyle=d.currentStyle=d.style);c&&c.appendChild(d);return d};Blockly.isRightButton=function(a){return a.ctrlKey&&goog.userAgent.MAC?!0:2==a.button};
...
b.contentLeft,-d-b.contentTop);a.stopPropagation()}};Blockly.onMouseMoveTracking_=function(a){Blockly.mainWorkspace.mousePosition=Blockly.mouseToSvg(a)};Blockly.onMouseWheel_=function(a){if(Blockly.mainWorkspace.scrollbar&&Blockly.mainWorkspace.zooming){Blockly.hideChaff();a=window.event||a;var b=Math.max(-1,Math.min(1,a.wheelDelta||-a.detail));Blockly.zoom(Blockly.mainWorkspace.mousePosition.x,Blockly.mainWorkspace.mousePosition.y,b);a.preventDefault()}};
Blockly.zoom=function(a,b,c){var d=Blockly.mainWorkspace.scaleSpeed,e=Blockly.getMainWorkspaceMetrics_(),f=Blockly.svg.createSVGPoint();Blockly.getMainWorkspace().getCanvas();f.x=a;f.y=b;f=f.matrixTransform(Blockly.getMainWorkspace().getCanvas().getCTM().inverse());a=f.x;b=f.y;f=Blockly.getMainWorkspace().getCanvas();c=1==c?d:1/d;a=f.getCTM().translate(-(a*(c-1)),-(b*(c-1))).scale(c);a.a>=Blockly.mainWorkspace.minScale&&a.a<=Blockly.mainWorkspace.maxScale&&(Blockly.mainWorkspace.scale=a.a,Blockly.mainWorkspace.scrollX=
a.e-e.absoluteLeft,Blockly.mainWorkspace.scrollY=a.f-e.absoluteTop,Blockly.mainWorkspace.scrollbar.resize())};Blockly.zoomCenter=function(a){var b=Blockly.getMainWorkspaceMetrics_();Blockly.zoom(b.viewWidth/2,b.viewHeight/2,a)};Blockly.zoomReset=function(){var a=Blockly.getMainWorkspaceMetrics_();Blockly.mainWorkspace.scale=1;Blockly.mainWorkspace.scrollX=-a.absoluteLeft;Blockly.mainWorkspace.scrollY=-a.absoluteTop;Blockly.mainWorkspace.scrollbar.resize()};
...
b=0;b<e.length;b++)for(var c=e[b];c;)setTimeout(c.setCollapsed.bind(c,!1),a),c=c.getNextBlock(),a+=10};b.push(c)}Blockly.ContextMenu.show(a,b)}};Blockly.onContextMenu_=function(a){Blockly.isTargetInput_(a)||(Blockly.showContextMenu_(a),a.preventDefault())};Blockly.hideChaff=function(a){Blockly.Tooltip.hide();Blockly.WidgetDiv.hide();!a&&Blockly.mainWorkspace.toolbox_&&Blockly.mainWorkspace.toolbox_.flyout_&&Blockly.mainWorkspace.toolbox_.flyout_.autoClose&&Blockly.mainWorkspace.toolbox_.clearSelection()};
